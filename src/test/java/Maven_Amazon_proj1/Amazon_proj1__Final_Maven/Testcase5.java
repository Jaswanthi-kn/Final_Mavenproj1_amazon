...
import Maven_Amazon_proj1.Amazon_proj1__Final_Maven.Amazon_AddedToCart_Page;
import Maven_Amazon_proj1.Amazon_proj1__Final_Maven.Amazon_Checkout_Page;
...
public class Testcase5 extends Listeners_Screenshot
{
	@Test
	public void Login_Search_ClickFirstProduct_AddToWishlist_AddToCart_SelectAddress() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		Amazon_AddedToCart_Page a6=new Amazon_AddedToCart_Page(driver);
		a6.proceedtobuy_button_click();
		Thread.sleep(2000);
		Amazon_Checkout_Page a7=new Amazon_Checkout_Page(driver);
		a7.usethisaddress_button_click();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getTitle(), "Select a delivery address","Address not selected");
	}
}